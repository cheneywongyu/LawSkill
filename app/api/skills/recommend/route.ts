...
const keywordGroups = [
  { area: '数据保护', terms: ['dpa', 'data', '数据', '隐私', '跨境', '供应商', 'gdpr', 'pipl', 'dpdp', '个人信息'] },
  { area: '商业合同', terms: ['nda', '保密', '合同', '条款', '采购', 'saas', '责任限制', '违约'] },
  { area: '争议解决', terms: ['诉讼', '判决', '起诉', '上诉', '仲裁', '证据', '法院', '期限'] },
  { area: '公司并购', terms: ['尽调', '并购', '股权', '投资', '资料室', '红旗', '公司'] },
  { area: '劳动雇佣', terms: ['员工', '解除', '劳动', '裁员', '赔偿', '仲裁', '工伤'] },
  { area: '知识产权', terms: ['许可', '知识产权', '软件', '商标', '专利', '著作权', '开源'] },
  { area: '法律研究', terms: ['研究', '法规', '案例', '检索', '判例', '引用', '法律依据'] },
]
