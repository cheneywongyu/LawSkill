---
id: "b250a385-ef37-5e43-8ec1-84259568314e"
title: "Serious Incident Reporting - EU AI Act Article 73"
title_cn: "严重事件报告 - 欧盟人工智能法第 73 条"
slug: "serious-incident-reporting-eu-ai-act-article-73"
url: "https://lawve.ai/@werner-plutat/skill/serious-incident-reporting-eu-ai-act-article-73"
author: "Werner Plutat"
author_slug: "werner-plutat"
category: "compliance"
language: "en"
license: "AGPL 3.0"
jurisdictions: "EU"
...
# 严重事件报告 - 欧盟人工智能法第 73 条

原始名称：`Serious Incident Reporting - EU AI Act Article 73`  
作者：Werner Plutat  
分类：compliance  
来源：https://lawve.ai/@werner-plutat/skill/serious-incident-reporting-eu-ai-act-article-73  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

根据《欧盟人工智能法》（条例 (EU) 2024/1689）第 73 条，针对高风险人工智能系统进行严重事件报告 (SIR)。评估、资格、起草和提交艺术。 73 项 SIR 通知涵盖四项艺术。 3(49) 伤害类别（死亡或严重健康损害、关键基础设施破坏、侵犯基本权利、财产或环境损害）。涵盖艺术。 73 立即、2/10/15 天报告窗口、市场监督机构通知、第 15 条规定的部署者职责。 26(5)，以及与 GDPR Art 的交叉监管映射。 33/34 违规通知，NIS2 艺术。 23 事件报告，DORA 艺术。 19 ICT事件和MDR警惕。专为处理 AI 事件、构建 AI 事件响应手册或管理 AI 故障、AI 偏见或自动决策事件的内部法律顾问和 AI 风险团队而构建。 DACH 通过德国市场监管（BNetzA、BaFin、BSI、BfArM、KBA）进行路由。与欧盟 AI 法案系统分类器、高风险准备、FRIA 和 GPAI 实践守则技能配对。
