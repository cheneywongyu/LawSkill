---
id: "0c69f0cf-0795-505c-9966-a060d4744bc1"
title: "outside-counsel-billing-and-performance-reviewer"
title_cn: "外部顾问计费和绩效审核员"
slug: "outside-counsel-billing-and-performance-reviewer"
url: "https://lawve.ai/@carl-ditzler/skill/outside-counsel-billing-and-performance-reviewer"
author: "Carl Ditzler"
author_slug: "carl-ditzler"
...
原始名称：`outside-counsel-billing-and-performance-reviewer`  
作者：Carl Ditzler  
分类：legal-operations  
来源：https://lawve.ai/@carl-ditzler/skill/outside-counsel-billing-and-performance-reviewer  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

审查内部法律部门的外部顾问发票和相关计费数据，包括 LEDES 或电子账单导出、OCG、批准费率、折扣、预算、AFA 和人员配置规则。在引入外部数据之前从内部比较开始。生成发票审核结果、MBR/QBR 记分卡、争议日志和管理报告。仅用于演示目的，不构成专业建议。
