---
id: "9ad3e9af-1d83-5b06-b59d-2ef2d2642e88"
title: "Connecticut Divorce Planner"
title_cn: "康涅狄格州离婚策划师"
slug: "connecticut-divorce-planner"
url: "https://lawve.ai/@stephane-boghossian/skill/connecticut-divorce-planner"
...
原始名称：`Connecticut Divorce Planner`  
作者：Stephane Boghossian  
分类：legal-drafting  
来源：https://lawve.ai/@stephane-boghossian/skill/connecticut-divorce-planner  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

克劳德的技能使克劳德成为康涅狄格州特有的离婚策划师——从飞行前接收到判决后修改的九种操作模式，以 Untangle.us 的功能界面为蓝本，并以 C.G.S. 为基础。标题 46b、练习手册第 25 章和 2026 年 8 月 1 日 CCSG 时间表。涵盖资格分类（§ 46b-44a 下的非对抗性与标准）、财务宣誓书 (JD-FM-6)、子女抚养费 (JD-FM-220 / CCSG-1 / 1A)、赡养费（§ 46b-82 的十四个因素）、育儿计划（JD-FM-224 下的 GAL/AMC 升级）、和解协议（JD-FM-172，TCJA 感知）、归档包（元帅 12 天规则、360 美元 + 50 美元费用、JD-FM-75 豁免）和判决后动议练习。硬 UPL 门：拒绝非 CT、家庭暴力（参考 CTCADV 1-888-774-2900）、隐藏资产、法庭辩护。赫普纳意识：人工智能提示没有特权。 Lawvable 登记处的第一个家庭法技能。
