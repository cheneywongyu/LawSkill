---
id: "5cb3dae2-79ed-55c6-beb3-6e833a778a47"
title: "analyse-sanctions-et-exportations"
title_cn: "分析制裁和出口"
slug: "analyse-sanctions-et-exportations"
url: "https://lawve.ai/@gillan-saleh/skill/analyse-sanctions-et-exportations"
author: "Gillan Saleh"
...
原始名称：`analyse-sanctions-et-exportations`  
作者：Gillan Saleh  
分类：compliance  
来源：https://lawve.ai/@gillan-saleh/skill/analyse-sanctions-et-exportations  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

Claude Desktop 分析国际经济制裁和出口控制。筛选 30 多个官方列表（ONU、UE、OFAC、OFSI、DGT France...），分析部门、双重用途（UE 2021/821 法规）、美国/中国的域外制度（EAR、ITAR、FDPR、ECL）、有风险的 USD/SWIFT 以及 30 多个司法管辖区的制图。结果来源和验证在时间里 - aucune response de mémoire。用法语、英语、阿勒曼语、西班牙语、俄语和汉语进行回复。 2026 年 5 月 19 日消息（20ème paquet UE、SEUC UK、EO Cuba）。 Outil indicatif — ne se substitue pas à un avis juridique。
