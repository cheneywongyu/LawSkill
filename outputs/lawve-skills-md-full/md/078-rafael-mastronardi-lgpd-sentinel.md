---
id: "e3d07cb4-5f35-5ed3-8c50-5c962dda2828"
title: "LGPD Sentinel"
title_cn: "LGPD哨兵"
slug: "lgpd-sentinel"
url: "https://lawve.ai/@rafael-mastronardi/skill/lgpd-sentinel"
...
分类：data-protection  
来源：https://lawve.ai/@rafael-mastronardi/skill/lgpd-sentinel  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

LGPD 针对巴西加工业务的指南。涵盖法律依据（第 7 条和第 11 条）、DPIA、事件（第 48-49 条）、数据主体权利（第 18 条）和国际传输。触发因素：LGPD、DPIA、ANPD、数据保护、个人数据、同意、数据保护官、巴西 DPO、数据事件、合法权益。
