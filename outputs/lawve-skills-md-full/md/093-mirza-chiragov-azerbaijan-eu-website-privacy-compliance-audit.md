---
id: "3b157b22-b891-5fa1-af9a-ad9b78280594"
title: "Azerbaijan + EU Website Privacy Compliance Audit"
title_cn: "阿塞拜疆+欧盟网站隐私合规审计"
slug: "azerbaijan-eu-website-privacy-compliance-audit"
url: "https://lawve.ai/@mirza-chiragov/skill/azerbaijan-eu-website-privacy-compliance-audit"
author: "Mirza Chiragov"
author_slug: "mirza-chiragov"
...
原始名称：`Azerbaijan + EU Website Privacy Compliance Audit`  
作者：Mirza Chiragov  
分类：technology-law  
来源：https://lawve.ai/@mirza-chiragov/skill/azerbaijan-eu-website-privacy-compliance-audit  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

审核网站是否遵守阿塞拜疆个人数据法第 998-IIIQ 号以及适用的欧盟 GDPR 和 ePrivacy/cookie 同意规则。清点现有的隐私文件（隐私政策、Cookie 政策、Cookie 横幅、同意流程、控制者和 DPO 联系方式、数据主体权利渠道、跨境传输披露、AZ 运营商注册参考），并根据适用的法定要求对每一项进行评分。生成双层报告：为企业主提供简单语言的红绿灯摘要，以及为律师提供的带有文章级引用的逐条调查结果表。仅评估，不起草。每当用户共享基于可用区或针对可用区的站点的 URL 或隐私/cookie 策略文本时使用；此外，当用户提及 .az 域名时，第 998 号法律、AZ 国家登记册、ePrivacy、Art. 27 欧盟代表，或询问“我的网站是否符合 GDPR 要求”、“我是否需要在阿塞拜疆注册为运营商”或“我们的 cookie 横幅是否合法”，即使没有“审核”一词。
