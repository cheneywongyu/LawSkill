---
id: "716623f5-f2f2-5c2b-b0db-fb0db844979c"
title: "Settlement Pressure Tester"
title_cn: "沉降压力测试仪"
slug: "settlement-pressure-tester"
url: "https://lawve.ai/@larissa-meredith-flister/skill/settlement-pressure-tester"
...
原始名称：`Settlement Pressure Tester`  
作者：Larissa Meredith-Flister  
分类：litigation  
来源：https://lawve.ai/@larissa-meredith-flister/skill/settlement-pressure-tester  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

该技能在报价发出或返回之前对拟议的和解立场进行压力测试：它所依赖的假设、你的杠杆和对手的杠杆、明显的弱点、对手可能的反应以及围绕它的时间和成本压力。它构建和解判断以做出更明智的决策；它不建议是否解决。
