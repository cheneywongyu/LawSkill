---
id: "7675b96d-cd6d-5c8d-89ce-02c1b270c880"
title: "Mediation Dispute Analysis"
title_cn: "调解纠纷分析"
slug: "mediation-dispute-analysis"
url: "https://lawve.ai/@jinzhe-tan/skill/mediation-dispute-analysis"
author: "Jinzhe Tan"
author_slug: "jinzhe-tan"
category: "litigation"
language: "en"
license: "AGPL 3.0"
jurisdictions: "INT"
...
原始名称：`Mediation Dispute Analysis`  
作者：Jinzhe Tan  
分类：litigation  
来源：https://lawve.ai/@jinzhe-tan/skill/mediation-dispute-analysis  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

以调解为目的分析法律纠纷——审查案件材料（诉状、合同、信件、证据），识别有争议的问题，总结各方的立场和利益，对关键问题进行法律分析，提出调解策略或和解方向，并准备调解会议。

每当用户提及调解、争议分析、和解、ADR、争议解决、政党立场、核心小组策略，或要求以解决方案为导向（而不是诉讼为导向）的目标分析两方或多方之间的冲突时，包括当他们上传案件文件并要求对谁想要什么或如何解决案件进行结构化分析时，即使他们没有明确表示“调解”，也可以使用此技能。
