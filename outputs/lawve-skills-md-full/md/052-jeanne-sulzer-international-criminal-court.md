---
id: "4e5c6dd2-493f-55c8-8249-036a43a22a07"
title: "international-criminal-court"
title_cn: "国际刑事法院"
slug: "international-criminal-court"
url: "https://lawve.ai/@jeanne-sulzer/skill/international-criminal-court"
...
原始名称：`international-criminal-court`  
作者：Jeanne Sulzer  
分类：human-rights  
来源：https://lawve.ai/@jeanne-sulzer/skill/international-criminal-court  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

涉及国际刑事法院（罗马规约体系）的研究、起草和分析。强制执行验证优先的方法 - 每个判例法、判决、备案、保证和声明引用在出现在输出中之前都会根据当前对话中的权威主要来源（icc-cpi.int、legal-tools.org）进行验证。基础文本（《罗马规约》、《犯罪要件》、《RPE》、《法院条例》）可以从存在的项目知识中引用。当用户使用 ICC 判例法、OTP 声明、ASP 文件或 ICC 程序时使用。
