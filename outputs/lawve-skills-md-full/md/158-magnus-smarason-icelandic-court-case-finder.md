---
id: "1dbf4701-2074-5bb7-b1d8-13a093a0762f"
title: "Icelandic Court Case Finder"
title_cn: "冰岛法院案件查找器"
slug: "icelandic-court-case-finder"
url: "https://lawve.ai/@magnus-smarason/skill/icelandic-court-case-finder"
...
原始名称：`Icelandic Court Case Finder`  
作者：Magnus Smárason  
分类：legal-research  
来源：https://lawve.ai/@magnus-smarason/skill/icelandic-court-case-finder  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

当被要求查找、引用、分析或总结冰岛法院判决时，请使用此技能。触发涉及 Hæstiréttur（最高法院）、Landsréttur（上诉法院）、Félagsdómur（劳动法院）、héraðsdómur（地区法院）判例法或冰岛法律先例研究的请求。
