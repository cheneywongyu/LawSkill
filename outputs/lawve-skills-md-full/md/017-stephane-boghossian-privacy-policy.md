---
id: "78c461ec-bc0f-5f91-9b91-9723b47b54b4"
title: "Privacy Policy"
title_cn: "隐私政策"
slug: "privacy-policy"
url: "https://lawve.ai/@stephane-boghossian/skill/privacy-policy"
author: "Stephane Boghossian"
author_slug: "stephane-boghossian"
category: "compliance"
language: "en"
license: "AGPL 3.0"
jurisdictions: "INT, EU, US, UK, CA"
status: "active"
source_index: 17
...
分类：compliance  
来源：https://lawve.ai/@stephane-boghossian/skill/privacy-policy  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

一个零幻觉的隐私政策生成器，可以让任何人（从非律师创始人到律师）从指导性摄入到可发布的、具有管辖权意识的隐私政策。管辖权优先：它检测您的用户所在位置适用的法律，然后仅起草所需的条款 - GDPR/EU + 英国、美国（CCPA/CPRA、~20 个州法律、COPPA、部门覆盖）和全球/MENA（LGPD、魁北克法律 25、印度 DPDP、中国 PIPL、阿联酋/DIFC、沙特 PDPL），以及应用商店、cookie 和 AI/欧盟 AI 法案披露。它的规则是：只陈述你确认的内容；永远不要发明法规、罚单、罚款或日期——每项声明都引用来源并经过质量检查。不是法律建议。
