---
id: "40f52c7b-44be-5cd9-ae7a-f7aa2e7c22ec"
title: "Client Explanation Translator"
title_cn: "客户解释翻译"
slug: "client-explanation-translator"
url: "https://lawve.ai/@larissa-meredith-flister/skill/client-explanation-translator"
...
原始名称：`Client Explanation Translator`  
作者：Larissa Meredith-Flister  
分类：legal-drafting  
来源：https://lawve.ai/@larissa-meredith-flister/skill/client-explanation-translator  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

将复杂的法律分析转化为面向客户的清晰且具有商业价值的建议。每当用户拥有密集的法律材料（起草、内部分析、律师笔记、研究备忘录、诉状、案件更新或信件）并希望将其转换为客户可以实际理解并采取行动的内容时，请使用此功能。触发诸如“向客户解释这一点”、“用简单的英语表达”、“为非律师翻译”、“将其转化为面向客户的建议”、“让客户做好准备”、“起草客户更新”等短语，或者当用户分享法律分析并询问“这对他们意味着什么”时触发。当用户想要董事会摘要、诉讼风险更新或源自法律材料的调用脚本时也会触发。该技能保留了法律的细微差别、不确定性和风险，而不是过于简单化——它使建议变得可用，而不仅仅是简单。
