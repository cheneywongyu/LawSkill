---
id: "9375c0e3-6e27-5349-bccb-588fddb8633d"
title: "runtime-admissibility-review"
title_cn: "运行时准入审查"
slug: "runtime-admissibility-review"
url: "https://lawve.ai/@arkadiy-miteiko/skill/runtime-admissibility-review"
author: "Arkadiy Miteiko"
author_slug: "arkadiy-miteiko"
category: "banking-finance"
language: "en"
license: "AGPL 3.0"
jurisdictions: "INT, EU, UK, US, AE"
status: "active"
source_index: 18
...
原始名称：`runtime-admissibility-review`  
作者：Arkadiy Miteiko  
分类：banking-finance  
来源：https://lawve.ai/@arkadiy-miteiko/skill/runtime-admissibility-review  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

确定特定人工智能代理的行动、输出、建议或拟议承诺在当前权限、授权范围、证据、事实、政策、风险、升级和撤销条件下是否仍可接受执行或机构依赖。在企业或受监管的人工智能代理执行、更新记录、触发工作流程、外部通信之前，或在机构依赖代理输出以产生法律、财务、运营、监管、客户、员工、患者、公民、市场、合同或声誉后果之前使用此技能。
