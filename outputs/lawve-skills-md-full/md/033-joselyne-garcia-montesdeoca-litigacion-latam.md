---
id: "b632fa85-6268-53d6-a0c2-a47e8977dbea"
title: "Litigación Latam"
title_cn: "拉丁美洲诉讼"
slug: "litigacion-latam"
url: "https://lawve.ai/@joselyne-garcia-montesdeoca/skill/litigacion-latam"
author: "Joselyne García Montesdeoca"
author_slug: "joselyne-garcia-montesdeoca"
category: "litigation"
language: "es"
license: "AGPL 3.0"
jurisdictions: "INT"
...
原始名称：`Litigación Latam`  
作者：Joselyne García Montesdeoca  
分类：litigation  
来源：https://lawve.ai/@joselyne-garcia-montesdeoca/skill/litigacion-latam  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

拉丁美洲民事诉讼专家顾问。该计划旨在协助诉讼代理人、内部法律设备和客户指导拉丁美洲的诉讼程序、法律分析和民事诉讼程序的方向。最后一个部分将在电子邮报中编辑，以恢复客户的大厅。

五次操作方式： 1) 策略：以诉讼方式进行，通过程序进行，以构建客户的位置。 2) Riesgo：评估viabilidad、probabilidades de éxito、prescripción、caducidad。 3) 过程：过程、广场、递归、中间步骤。 4) Asesoría cliente：explicaciones claras para clientes。 5) 向客户发送电子邮件：自动通过电子邮件发送最终分析结果。
