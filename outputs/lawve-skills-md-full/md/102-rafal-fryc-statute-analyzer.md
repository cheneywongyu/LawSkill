---
id: "8a05fa04-cd99-5485-80ab-4b9c48a3ee65"
title: "Statute Analyzer"
title_cn: "法规分析器"
slug: "statute-analyzer"
url: "https://lawve.ai/@rafal-fryc/skill/statute-analyzer"
author: "Rafal Fryc"
...
原始名称：`Statute Analyzer`  
作者：Rafal Fryc  
分类：legal-research  
来源：https://lawve.ai/@rafal-fryc/skill/statute-analyzer  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

在法律和合规环境中阅读、解释和应用法规、法规和规则的指南。当用户询问以下问题时使用：(1) 如何阅读和解释法规、条例或规则，(2) 法规解释方法和解释规范，(3) 了解立法意图，(4) 将法规应用于特定法律情况，(5) 从法律文本中提取要求，(6) 区分不同类型的法律要求，或 (7) 跨司法管辖区合规性分析。
