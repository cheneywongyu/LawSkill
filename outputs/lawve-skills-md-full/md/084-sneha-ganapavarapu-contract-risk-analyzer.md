---
id: "ff449048-8cbc-5cf3-a4d7-6c30e3bf2306"
title: "Contract Risk Analyzer"
title_cn: "合同风险分析器"
slug: "contract-risk-analyzer"
url: "https://lawve.ai/@sneha-ganapavarapu/skill/contract-risk-analyzer"
author: "Sneha Ganapavarapu"
author_slug: "sneha-ganapavarapu"
...
原始名称：`Contract Risk Analyzer`  
作者：Sneha Ganapavarapu  
分类：commercial-law  
来源：https://lawve.ai/@sneha-ganapavarapu/skill/contract-risk-analyzer  
...
一项实用的合同分析技能，专为未经法律培训的创始人和早期公司而设计。
...
对于每个条款，您都会获得简单的英语解释、需要注意的具体危险信号以及您可以实际使用的谈判语言。

## 这是给谁的

创始人和早期企业家在没有聘请律师的情况下审查供应商协议、服务合同和合作伙伴协议。

## 作者

由律师出身的产品构建者 Sneha Ganapavarapu 创建，拥有知识产权许可法、B2B SaaS 产品管理和法律技术背景。这项技能源自她的从业经验和合同风险分析工具 Pactora。
...
该技能提供分析和指导，**不是法律建议**。每份合同都是不同的。使用此分析来为您的决策提供信息，而不是取代专业法律顾问。您对您同意的内容负责。

## 许可证

CC BY-NC-ND 4.0 — 欢迎您使用和分享此技能，但不得修改或用于商业用途。
...
A practical contract analysis skill built for founders and early-stage companies with no legal training.

## What This Skill Does

Analyses contracts across five critical clauses that make or break deals:
- **Limitation of Liability** — Financial exposure caps
- **Indemnities** — Who pays if things go wrong
- **IP Ownership** — Who owns what you create
- **Data Protection** — Legal data handling obligations
- **Termination** — Exit flexibility and post-contract obligations

For each clause, you get plain-English explanations, specific red flags to watch for, and negotiation language you can actually use.

## Who This Is For

Founders and early-stage entrepreneurs reviewing vendor agreements, service contracts, and partnership deals without a lawyer on retainer.

## Author

Built by Sneha Ganapavarapu, a lawyer-turned-product builder with background in IP licensing law, B2B SaaS product management, and legal tech. This skill draws from her practitioner experience and her contract risk analysis tool, Pactora.

## How to Use

1. Upload or paste your contract
2. Answer clarifying questions about the deal
3. Review the risk analysis across all five clauses
4. Use the suggested negotiation language to push back on unfavourable terms
5. Get a lawyer to review before signing

## Disclaimer

This skill provides analysis and guidance, **not legal advice**. Every contract is different. Use this analysis to inform your decisions, not replace professional legal counsel. You are responsible for what you agree to.

## License

CC BY-NC-ND 4.0 — You're welcome to use and share this skill, but not modify or use commercially.
...
description: "Analyses contracts for risk across five critical clauses (Limitation of Liability, Indemnities, IP Ownership, Data Protection, Termination). Built for founders with no legal background. Flags red flags, explains risks in plain language, and provides negotiation guidance."
metadata:
  author: "Sneha Ganapavarapu"
  license: "cc-by-4.0"
  version: "2026-05-17"
...
**What it means:**
If the other party messes up and causes you financial damage, they want to limit how much they have to pay you. This clause sets a cap on your damages.

**Why it matters to founders:**
If a vendor crashes your data, or a partner fails to deliver, you want to know the maximum you can recover. A one-sided limitation of liability clause means you're bearing all the risk.
...
**What it means:**
An indemnity is a promise to reimburse the other party if a third party sues them over something *you* did (or didn't do). You're essentially buying their legal insurance.

**Why it matters to founders:**
If your product infringes someone's patent, or you accidentally use someone's copyrighted content, they want *you* to pay for their legal defence. Broad indemnity clauses can bankrupt early-stage companies.
...
**What it means:**
Who owns the intellectual property (code, designs, content, processes) created during the relationship?

**Why it matters to founders:**
This is *everything.* If you build something valuable, you need to own it. Ambiguous IP ownership can derail fundraising, product pivots, or exits.
...
**What it means:**
If you collect, store, or process customer data, user data, or any personal information, this clause says how you have to handle it legally.

**Why it matters to founders:**
Data breaches are expensive (fines, liability, reputation damage). If you're handling data and you're not compliant, you're exposed. GDPR (Europe), CCPA (California), and other laws impose heavy fines for mishandling data.
...
**What it means:**
How, when, and on what terms can either party end the contract? What happens to data, payments, and IP after?

**Why it matters to founders:**
Bad termination clauses can lock you in, require expensive penalties to exit, or leave you without access to critical data or tools. Early-stage companies need flexibility.
