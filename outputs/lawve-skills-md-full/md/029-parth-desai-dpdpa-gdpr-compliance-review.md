---
id: "8f17bc6f-4f4c-5023-a8be-148602bed437"
title: "DPDPA & GDPR Compliance Review"
title_cn: "DPDPA 和 GDPR 合规审查"
slug: "dpdpa-gdpr-compliance-review"
url: "https://lawve.ai/@parth-desai/skill/dpdpa-gdpr-compliance-review"
author: "Parth Desai"
...
原始名称：`DPDPA & GDPR Compliance Review`  
作者：Parth Desai  
分类：data-protection  
来源：https://lawve.ai/@parth-desai/skill/dpdpa-gdpr-compliance-review  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

针对印度的 DPDPA 2023 和欧盟 GDPR 进行结构化合规性审查、条款修订以及法律文件（隐私政策、数据处理协议、供应商和 SaaS 合同）的起草建议。通过推理将条款标记为合规、有风险或不合规，并提出现成的模型替换语言。
