---
id: "245943a0-ce01-5dda-a244-cdfb1345e2a8"
title: "EU AI Act System Classifier"
title_cn: "欧盟人工智能法案系统分类器"
slug: "eu-ai-act-system-classifier"
url: "https://lawve.ai/@werner-plutat/skill/eu-ai-act-system-classifier"
...
作者：Werner Plutat  
分类：compliance  
来源：https://lawve.ai/@werner-plutat/skill/eu-ai-act-system-classifier  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

根据《欧盟人工智能法案》（法规 (EU) 2024/1689）对人工智能系统进行分类，并映射随后的合规义务。行走艺术。 2 范围排除，艺术。 3(1) 人工智能系统定义（7 标准测试），Art. 3(1) 5 禁止做法筛选，附件一和附件三高风险评估同Art.5。 6(3) 狭义程序例外，艺术。 51-56 GPAI 具有 10^25 FLOP 系统风险阈值，以及 Art。 50 个透明度触发器。专为内部顾问对真实系统进行分类而构建：医学成像、医疗设备、信用评分、保险定价、人力资源或简历筛选、生物特征识别、情感识别、深度伪造或合成内容、内容审核、欺诈检测、生成人工智能或基础模型部署。用于 Betriebsrat 咨询、BaFin、BSI、BNetzA、BfDI 的 DACH 路由。与欧盟人工智能法案高风险实施准备、FRIA、GPAI 实践守则以及下游工作流程的严重事件报告技能相匹配。
