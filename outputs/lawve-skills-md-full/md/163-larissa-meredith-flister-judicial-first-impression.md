---
id: "de20fd4e-720b-5976-aafe-05a142b9a751"
title: "Judicial First Impression"
title_cn: "司法第一印象"
slug: "judicial-first-impression"
url: "https://lawve.ai/@larissa-meredith-flister/skill/judicial-first-impression"
...
原始名称：`Judicial First Impression`  
作者：Larissa Meredith-Flister  
分类：litigation  
来源：https://lawve.ai/@larissa-meredith-flister/skill/judicial-first-impression  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

从法官在时间压力下冷读的角度评估法律论证、意见或结构化推理。生成一个由七部分组成的结构化评估：案例的内容、直接的困惑点、感觉强的内容、感觉弱的内容、假设但未经证实的内容、临时置信水平（低/中/高）以及需要说服的内容。这项技能不会重写、改进或攻击论点——它告诉你它实际上如何落在一个持怀疑态度、经验丰富的读者身上，而没有任何先验背景。涉及框架论据、证人陈述、诉讼前信件、立场声明、学术文章和非法律结构化推理。
