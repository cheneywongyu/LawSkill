---
id: "4c20270b-a5cc-5a17-aa2d-5936c0b03aae"
title: "Opposing Counsel Review"
title_cn: "反对律师审查"
slug: "opposing-counsel-review"
url: "https://lawve.ai/@larissa-meredith-flister/skill/opposing-counsel-review"
author: "Larissa Meredith-Flister"
author_slug: "larissa-meredith-flister"
category: "litigation"
language: "en"
license: "Apache 2.0"
jurisdictions: "UK"
...
原始名称：`Opposing Counsel Review`  
作者：Larissa Meredith-Flister  
分类：litigation  
来源：https://lawve.ai/@larissa-meredith-flister/skill/opposing-counsel-review  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

担任经验丰富的对方律师，攻击、破坏和揭露法律论证、陈词、证人陈述或结构化推理中的弱点。

产生由六部分组成的对抗性分析： 1. 攻击的核心理论，确定击败论证的最有效的单一方法； 2. 对立论点的重构版本，去除了修辞以暴露其脆弱性； 3. 按类别分组的主要攻击线（法律错误陈述、证据差距、因果关系失败、内部不一致、过度依赖断言、程序缺陷）； 4. “如果我是法官”部分显示持怀疑态度的法庭将如何驳回论点； 5. 外科手术式打击——3到5个高影响点准备口头提交； 6. 分析论证试图隐藏的内容。

以正式的、对抗性的英式英语编写，面向受过法律培训的读者。
...
description: >-
  ...
  Produces a six-part adversarial analysis: 
  1. A core theory of attack identifying the single most effective way to defeat the argument; 
  2. A reconstructed version of the opposing argument stripped of rhetoric to expose its fragility; 
  3. Primary lines of attack grouped by category (legal misstatement, evidential gaps, causation failures, internal inconsistency, over-reliance on assertion, procedural weakness); 
  4. An "if I were the judge" section showing how a sceptical tribunal would dismantle the argument; 
  5. Surgical strikes - 3 to 5 high-impact points ready for oral submissions; and 
  6. An analysis of what the argument is trying to hide. 
