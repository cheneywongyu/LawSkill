---
id: "e670fa67-2edd-5dbe-b0c1-747afe835e6b"
title: "Trademark Search"
title_cn: "商标检索"
slug: "trademark-search"
url: "https://lawve.ai/@robb-miller/skill/trademark-search"
author: "Robb Miller"
author_slug: "robb-miller"
...
原始名称：`Trademark Search`  
作者：Robb Miller  
分类：intellectual-property  
来源：https://lawve.ai/@robb-miller/skill/trademark-search  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

在美国和加拿大进行面向律师的淘汰/可用性商标搜索。每当用户（创始人、客户或律师）询问品牌、标记、名称、徽标、口号或产品名称是否“可用”、“免费使用”、“可清除”或“已使用”时使用，或者要求 Claude “搜索商标注册簿”、“检查 USPTO”、“检查 CIPO”、“进行淘汰搜索”、“许可搜索”、“可用性搜索”或“查看[标记]是否已注册商标。”即使用户随意说出它（“我可以称呼我的公司 X 吗？”、“这个名字有人用吗？”）时也会触发。涵盖联邦美国专利商标局 (TESS/TSDR)、加拿大联邦 (CIPO)、普通法/网络/州和 WIPO 马德里国际。输出是一份淘汰赛可用性备忘录，带有绿色/黄色/红色判决，供律师审查。包括实质性分析之前的专业责任门控（人工智能使用披露、冲突检查、范围确认）。不是法律建议——为律师签字生成工作产品。
