---
id: "c4903f39-92b6-5853-91c6-c1c45323e939"
title: "climate-aligned-contracts"
title_cn: "气候相关合同"
slug: "climate-aligned-contracts"
url: "https://lawve.ai/@tclp/skill/climate-aligned-contracts"
author: "The Chancery Lane Project"
author_slug: "tclp"
category: "commercial-law"
language: "en"
license: "MIT"
jurisdictions: "UK, EU, INT"
status: "active"
source_index: 71
...
原始名称：`climate-aligned-contracts`  
作者：The Chancery Lane Project  
分类：commercial-law  
来源：https://lawve.ai/@tclp/skill/climate-aligned-contracts  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

起草、调整和审查与 Chancery Lane 项目通过法律协议减少碳排放的方法相一致的合同和条款。当 Claude 需要：(1) 起草新的气候相关条款（例如净零承诺、碳核算、供应链脱碳），(2) 调整或修改现有合同以纳入气候目标，(3) 审查和分析条款以符合气候目标和脱碳战略，(4) 为赞善里项目的内部风格和气候意识法律工作的起草方法提供指导。
...
**Process:**
1. Identify the clause type and contractual context
2. Review relevant example clauses in `references/` for established patterns
3. Adapt the approach to the specific jurisdiction and contract type
4. Apply house style and drafting principles (see House Style section)
5. If jurisdiction-specific legislation is relevant, use web_search to find current requirements
...
1. **Embedding climate in core obligations**: Not just side letters or ancillary provisions
2. **Alignment with science**: Reference to credible frameworks (Paris Agreement, Science Based Targets initiative, etc.)
3. **Accountability mechanisms**: Regular reporting, verification, and consequences for non-performance
4. **Transition planning**: Recognition that decarbonization is a journey requiring staged commitments
5. **Collaboration over punishment**: Encourage joint problem-solving and continuous improvement
...
1. Review relevant examples to understand established patterns
2. Adapt the approach to the specific context
3. Do not copy verbatim—tailor language to the particular contract and parties
4. Consider how clauses interact with other contractual provisions
