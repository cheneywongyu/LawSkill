---
id: "7e54c9a6-fec1-579c-94fa-6b0ee8c68d15"
title: "gouvernance-societes-cotees"
title_cn: "治理协会"
slug: "gouvernance-societes-cotees"
url: "https://lawve.ai/@gillan-saleh/skill/gouvernance-societes-cotees"
author: "Gillan Saleh"
author_slug: "gillan-saleh"
...
原始名称：`gouvernance-societes-cotees`  
作者：Gillan Saleh  
分类：corporate-law  
来源：https://lawve.ai/@gillan-saleh/skill/gouvernance-societes-cotees  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

# 技能 — Gouvernance des émetteurs cotés (`gouvernance-emetteurs-cotes`)

对**政府的科学职业的纪录片进行分析
法国高地**。 Le Skill agrège, Sous forme d'**index analytiques
来源**、un corpus réglementaire et doctrinal daté（报告废除 AMF 和
HCGE 2020-2025，AMF 原则，应用指南 HCGE 2024-2025，代码
AFEP-MEDEF 2022，优先 ESMA 2025，指南 巴黎 Europlace 2024，融洽
sénatorial 2025，文本 légaux et européens — 详情参见“语料库索引”
ci-dessous) 和 permet de le resituer, de l'analysiser dans le temps et de
l'appliquer à un émetteur。

> **作者：吉兰·萨利赫。**
> 许可证：**CC BY-NC-SA 4.0**（查看“许可证”文件）。非商业用途。

---

## 这就是技能

三个用法，服务于 **13 个区块 (A-M)** 的分析公社：

1. **Restitution source** — 追溯 une 位置、une statistique 或 une
   引用准确，保存来源和页面。
2. **分析纵向** — 比较位置或位置的演变
   统计 dans le temps et entre 机构 (AMF / HCGE / ESMA)。
3. **Audit d'un émetteur** — appliquer la gride A-M à une société, àpartir de
   通用注册文件 (DEU)，完整的语料库索引
   et la recherche internet（理论、新闻、官方来源）。

## 示例（快速入门）

**用法 1 — 恢复来源。**
*问题*：《2022 年评估委员会的社会比例如何，请参见 AMF？ »
*回复类型*：selon le rapport AMF 2023 (p. 28), « 92 % des sociétés de l'échantillon » et « 100 % du CAC 40 de l'échantillon » ont procédé à une évaluation du conseil en 2022 (exercice 2022 ; périmètre : échantillon AMF, à ne pas confondre avec le SBF 120)。完整的，le cas échéant，par une recherche web pour tout développement postérieur。

**用法 2 — 纵向分析**（extrait de frise，主题 « évaluation du conseil »）：
- HCGE 2022 报告，第 14 页36：《所有社会团体都在委员会的评估中。 »
-《Rapport AMF 2024》，第 14 页36：向 21 个协会提出建议，不要 5 du CAC 40； 18 条规定。

顺序数据和并置，详细说明。 La frise remonte à la genèse antérieure au corpus et intègre les développements postérieurs，来自 recherche web。

**用法 3 — 审计 d'un émetteur** （额外插图；la fiche complète couvre les 13 blocs A-M, à partir du DEU de l'émetteur + corpus + web）：
- *Bloc B — 组成与独立*：独立行政人员的身份、资格主题、dépassement de douze ans — chaque constat source（融洽关系 + 页面）与 DEU 的对峙。
- *Bloc E — 薪酬/薪资*：薪酬结构、RSE 标准、公平比率（第 L. 22-10-9 条） — 与德国和薪酬关系融洽的确认。

Chaque bloc renvoie au corpus indexé（页面精确）和 la source primaire de l'émetteur（留置权）。

## 校长董事

- **Posure d'agrégateur objectif**：事实来源和趋势，敏锐的观点，
  aucun 形容词 评估。
- **严格分类法**：l'AMF（regulateur, nominatif assumé）、l'ESMA et l'ANC
  (regulateurs)、le HCGE et l'AFEP-MEDEF（软法、匿名原则）
  ne sont jamais concondus。
- **恢复文本**：引用mot pour mot，保存页面精确；希弗尔
  littéraux 的独特性； chaque 提及主格限定词的主题。
- **作者权**：引用限制和反悔 à la source pour les
  文件保护（HCGE，代码 AFEP-MEDEF）；直接归还灵魂
  事实是不可保护的。
- **Bloc J（持久性 CSRD/ESRS）**：地形有风险，encadré par un
  免责声明方法（模糊适用，制度 DPEF/CSRD）。

## 语料库索引

Liste exce des Documents Indexés (liens officiels pour les obtenir dans)
`references/sources.md`) :

- **AMF — 企业政府和社会团体薪酬报告年报**，**2020 年至 2025 年演习**（6 份报告）。
- **AMF — 原则**：通用注册文件详细说明指南（立场建议 **DOC-2021-02**）； 2025 年综合报告建议 (**DOC-2025-08**) ；持久性原则 DPEF/CSRD (**bilan 2024**) ； CSRD 练习曲《前进之路》（**2025**）。
- **HCGE — 2020 年到 2025 年的报告**（6 份报告）； **AFEP-MEDEF 代码应用指南**，版本**2024 年 3 月**和 **2025 年 12 月**。
- **ESMA** —priorités communes de control（欧洲共同执法优先事项），**2025**。
- **代码 AFEP-MEDEF**，版本**2022 年 12 月**（十字参考表，无文本复制）。
- **巴黎 Europlace** — 对话行动指南（**2024 年 6 月**）。
- **参议院** — rapport **n° 808 (2024-2025)**，commission d'enquête sur l'utilization des aides aux grandes entreprises et à leurs sous-traitants (Rietmann / Gay, **1er juillet 2025**) — volets gouvernance。
- **Textes légaux et européens**（通过 Légifrance / EUR-Lex，nonFigés）：Code de commerce、Code monétaire et financier、RGAMF、droit de l'Union（MAR、招股说明书、CSRD/ESRS、SRD II）。

语料库索引是 une **fenêtre 2020-2025** ;这是完整的系统
...
```
## Grille d'analysis（A-M 13 个区块）

A. 治理模式 · B. 理事会的组成和职能 ·
C. 继承和提名 · D. 委员会（不监督有风险的行为） ·
E. 报酬（不公平） · F. 国民大会和权利
行动者 · G. 补充金融家 · H. 遵守或解释 ·
I. 资本主义与控制的结构 · J. Durabilité (CSRD/ESRS) ·
K. 金融和额外金融信息 · L. Conseillers en vote
（代理顾问） · M. Notations et données ESG。

横向集团“Mixité et diversité”； rubrique « 新兴主题 »
（网络安全、IA dans la gouvernance、études thématiques）。

## 制作

Le Skill produit des **fiches émetteurs** et des **fiches thématiques** (Word),
chacune source, avec Difference des registres（语料库索引/原始来源
网络/来源二手），留置权与来源二手，et une présentation
适应移动讲座。 Chaque 生产端口在页面上提到：
...
```
五次检测：
- **D1** — 系列内联不完整（un sous-point sans itation à côté d'un voisin de même série qui en a une）。
- **D2 / D2b** — sous-sections skelettiques ou statistiques maigres（标题为无内容）。
- **D3** — guillemets « » déséquilibrés（引用 tronquée ou mal fermée）。
- **D4** — renvois-substituts（“figure p. X”，“disponible surdemande”）[指示]。
- **D5** — disparité de série (millésime atypiquement maigre ou dencatif) [指示]。

Un signalment n'est pas une erreur automatique : c'est un point à verifier à la
来源。 **丰富语料库**：PDF 区域索引器（ne jamais le）
再分发者 — voir `NOTICES.md`), ajouter son lien officiel dans
`references/sources.md`， puis lancer le détecteur。

## 第二个实例验证 — l'agent vérificateur
...
Agent qui se relit, et un agent peut se convaincre d'avoir verfié ce qu'il n'a
帕斯鲁韦。保函保证不影响您的交付
Producteur — elle vient d'une **第二个实例，neutre et fraîche**，qui ne
请确认产品是否合格。

D'où un protocole simple, que l'on orchester soi-même en **deux requêtes
连续**：

1. **Producteur** — 具有技能的首个实例产品。
2. **Vérificateur** — dans une **conversation neuve**, une secondary example reçoit
   la fiche et les sources, et n'a qu'une tâche : 审计员 la fidélité, 肯定
   平价的肯定。 Elle ne réécrit pas, ne complète pas, n'améliore pas — elle
   验证和产品 une **预先表**。

L'indépendance ne se décrète pas : elle tiient au fait que le verificateur est une
实例不同。不需任何技能，请检查真实情况
独立的；这就是第二次分离的用途
请求。验证短语的标准：**« montre-moi la page ».**

### Protocole d'audit de fidélité（在新对话中）
```
...
Le détecteur `check_completeness.py` (ci-dessus) 和 l'agent verificateur sont
补充： 非洲对抗区域总理**信号**机制
PDF ；第二次 **审核** la fidélité d'une 制作完成，确认标准
确认，depuis une instant indépendante。

## 限制

- 2025 年索引已发布；为了法律和现实的权利，
  le Skill complète par une recherche internet（Légifrance、EUR-Lex、网站
  官员）。
- 科学职业分析纪录片的技能产品。 **伊恩
  构成你的司法委员会，你的投资委员会。**
...
Œuvre sous **知识共享归属 - Pas d'Utilization Commerciale -
在 les Mêmes Conditions 4.0 International 中分享 (CC BY-NC-SA 4.0)**。

您拥有分享和适配器技能，条件为 **créditer Gillan
Saleh**、de **ne pas en faire un use Commercial**、et de **repartager à
同一性**。文件来源均保留编辑者的所有权
（参见“NOTICES.md”）。文件中许可证数字的完整文本
`许可证`。
