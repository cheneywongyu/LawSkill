---
id: "cac1a51d-32b9-5dbd-b9fd-9b1ebe54bb4f"
title: "normalisation-juridique"
title_cn: "司法正常化"
slug: "normalisation-juridique"
url: "https://lawve.ai/@christophe-quezel-ambrunaz/skill/normalisation-juridique"
...
原始名称：`normalisation-juridique`  
作者：Christophe Quézel-Ambrunaz  
分类：microsoft-office  
来源：https://lawve.ai/@christophe-quezel-ambrunaz/skill/normalisation-juridique  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

La compétence Normalization juridique FR nettoie un document Word rédigé en français juridique。 Elle distingue deux régimes : les Corrections déterministes (撇号 courbes, guillemets français, espaces insécables, insécables des reférences — art. 1240, n° 21-12.345, 50 % —, ordinaux 1ère → 1re, ligatures œ, la loi dispose et non stipule, anglicismes-calques), appliquées directement ; et les réécritures de jugement（virgule avant « et »、ternaires creux、formules emphatiques、harmonizes）、posées en révisions 单词 soumises à votre 接受。 Chaque Changement est consigné et Restitué en tableau récapitulatif : on revient en arrière mot à mot — « défais 3, 7-10 »。 La 归一化描述是纯粹的形式。使用 Cowork 或更详细的 Word 功能。
