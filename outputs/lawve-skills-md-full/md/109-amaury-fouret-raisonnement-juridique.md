---
id: "8022ad50-541b-5169-8f57-82cb40b0fa89"
title: "raisonnement-juridique"
title_cn: "法律理由"
slug: "raisonnement-juridique"
url: "https://lawve.ai/@amaury-fouret/skill/raisonnement-juridique"
author: "Amaury Fouret"
author_slug: "amaury-fouret"
...
原始名称：`raisonnement-juridique`  
作者：Amaury Fouret  
分类：legal-research  
来源：https://lawve.ai/@amaury-fouret/skill/raisonnement-juridique  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

模拟法国法官分析民事案件时的法律推理。使用此技能来分析争议并识别法律问题，构建结构化的法律论证（三段论），起草民事判决的推理，通过 Judilibre 和 Légifrance 搜索适用的判例法和法规，从法律上描述事实和行为，并区分主张、理由和论点。基于起草民事判决的方法指南（ENM/最高法院，2023 年）。
