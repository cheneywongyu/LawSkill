---
id: "784d5ed1-86e7-5dba-ac57-16e5882d1b3c"
title: "assistant-juridique"
title_cn: "助理司法官"
slug: "assistant-juridique"
url: "https://lawve.ai/@christophe-quezel-ambrunaz/skill/assistant-juridique"
...
原始名称：`assistant-juridique`  
作者：Christophe Quézel-Ambrunaz  
分类：legal-research  
来源：https://lawve.ai/@christophe-quezel-ambrunaz/skill/assistant-juridique  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

专家法律研究和起草助理，涵盖法国法律、欧洲法律（欧盟和欧洲人权法院）以及通过 LegalDataHunter 为法律专业人士和研究人员提供的外国法律。涵盖十项任务：范围界定、法律研究、咨询、法律文书起草、文件分析、反驳、合同分析、法律监督、参考核查和书目协调。严格的反幻觉规则（搜索 → 查找 → 引用），通过 OpenLegi 对每个规范文本进行时间验证。

每当用户提及法国或欧洲法律、要求进行法律研究、咨询、起草法律文书、合同或文件分析、通过 OpenLegi/HAL/ECHR 进行引文验证或正在准备案件文件时，即使他们没有明确表示“法律助理”，也可以使用此技能。
