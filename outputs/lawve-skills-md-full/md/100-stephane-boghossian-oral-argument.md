---
id: "a2c57b41-6876-59ba-bcfe-ca97c3cf6edd"
title: "Oral Argument"
title_cn: "口头辩论"
slug: "oral-argument"
url: "https://lawve.ai/@stephane-boghossian/skill/oral-argument"
...
分类：legal-operations  
来源：https://lawve.ai/@stephane-boghossian/skill/oral-argument  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

法庭准备技能以 Neal Katyal 2025 年 11 月 SCOTUS 关税论点和他的 AI 陪审伙伴“Harvey”为模型。五个阶段​​：（1）根据先前的意见、问题、同意和异议来描述每个决策者——表明他们的理论承诺和制度关注； (2) 预测替补席——每位法官提出 3-7 个可能的问题，每个问题背后都有担忧，在置信度高的情况下逐字逐句地表述； (3) 绘制逃生路线——每个持怀疑态度的法官在不放弃先前承诺的情况下可以签署的最窄限制； (4) 对抗性地争论——无情的跟进、重复的台词、跟踪哪些问题让律师感到困惑； (5) 将一张<150字的讲台索引卡交给律师。模特是陪练伙伴。律师仍然胜诉。用于口头辩论、动议听证会、证词、仲裁或提交前的压力测试摘要。
