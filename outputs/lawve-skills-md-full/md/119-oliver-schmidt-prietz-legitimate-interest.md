---
id: "574a824f-59b9-5449-a6a2-d2d122443e67"
title: "Legitimate Interest"
title_cn: "合法权益"
slug: "legitimate-interest"
url: "https://lawve.ai/@oliver-schmidt-prietz/skill/legitimate-interest"
author: "Oliver Schmidt-Prietz"
author_slug: "oliver-schmidt-prietz"
category: "data-protection"
language: "en"
license: "AGPL 3.0"
jurisdictions: "EU, UK, FR, DE"
status: "active"
source_index: 119
...
原始名称：`Legitimate Interest`  
作者：Oliver Schmidt-Prietz  
分类：data-protection  
来源：https://lawve.ai/@oliver-schmidt-prietz/skill/legitimate-interest  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

根据艺术进行结构化的合法利益评估（LIA）。 6(1)(f) GDPR 使用完整的 EDPB 三步测试 — 利益识别、严格必要性分析以及缓解的平衡测试。基于 EDPB 指南 1/2024、意见 28/2024（AI 模型）、CNIL 指南（2025 年 6 月）、ICO/DUA 法案 2025、CJEU 关键判决以及来自 DE/FR/NL/AT/IT/ES/UK 的 DPA 立场。包括人工智能/机器学习、营销、欺诈预防、儿童数据、员工监控、电子隐私重叠和跨境的专用模块，以及专用的反对权（第 21 条）响应模式和结构化 LIA 输出。

每当用户提及 GDPR Art 时，请使用此技能。 6(1)(f)、合法权益、LIA 或三步测试、EDPB/DPA 指南、AI 培训数据合法性、网络抓取合法性、直接营销或欺诈预防法律依据、员工监控、反对权或要求进行平衡测试 - 即使他们没有明确表示“LIA”。
