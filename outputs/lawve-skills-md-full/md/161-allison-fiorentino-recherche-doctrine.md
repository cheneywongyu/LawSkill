---
id: "48273462-b2f6-5a48-8bd9-6726f69faa2a"
title: "recherche-doctrine"
title_cn: "研究主义"
slug: "recherche-doctrine"
url: "https://lawve.ai/@allison-fiorentino/skill/recherche-doctrine"
author: "Allison Fiorentino"
author_slug: "allison-fiorentino"
category: "legal-research"
language: "fr"
license: "AGPL 3.0"
jurisdictions: "FR, EU, INT"
status: "active"
source_index: 161
...
原始名称：`recherche-doctrine`  
作者：Allison Fiorentino  
分类：legal-research  
来源：https://lawve.ai/@allison-fiorentino/skill/recherche-doctrine  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

法国、欧洲和国际法律学术数据库的学术研究。当用户请求搜索理论文章、论文、学术书籍或大学法律出版物（包括比较法）时，请使用此技能。主要来源：ISIDORE（CNRS 社会科学聚合器，包括 Cairn.info、Persée、OpenEdition）、HAL（法国开放档案）、OpenAlex（超过 2.5 亿作品的全球开放数据库）、Semantic Sc​​holar、CrossRef、Persée（直接 OAI）和 CORE。涵盖法语和国际法律学术，并具有内置的比较法双语工作流程。还触发：带注释的参考书目、最新技术、法律文献综述、作者检索、引文验证、文献计量分析。
