---
id: "7759e835-f79e-5205-8f97-d20f97189456"
title: "GPAI Code of Practice Compliance"
title_cn: "GPAI 实践守则合规性"
slug: "gpai-code-of-practice-compliance"
url: "https://lawve.ai/@werner-plutat/skill/gpai-code-of-practice-compliance"
...
原始名称：`GPAI Code of Practice Compliance`  
作者：Werner Plutat  
分类：compliance  
来源：https://lawve.ai/@werner-plutat/skill/gpai-code-of-practice-compliance  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

评估《人工智能法》（条例 (EU) 2024/1689）第 51-56 条中欧盟通用人工智能 (GPAI) 实践守则的遵守情况。涵盖 GPAI 模型识别（第 3(63) 条）、系统性风险模型指定（第 3(65) 条、第 51 条、10^25 FLOP 训练计算阈值）、第 3(63) 条规定的上游提供商义务。 53（透明度、技术文档、版权政策、培训数据摘要），第 53 条规定的附加系统性风险义务。 55（模型评估、对抗性测试、AI Office 事件通知、网络安全）、系统性风险通知和委员会指定。 52，下游艺术。 25 准提供者职责和艺术。 53(2) 开源豁免。专为内部法律顾问和 AI 治理团队构建，用于审查 LLM 或基础模型部署、起草 GPAI 合规计划或评估系统风险阈值。 DACH：BaFin、BSI、BNetzA。与欧盟人工智能法案系统分类器、高风险准备、FRIA 和严重事件报告技能配对。
