---
id: "ddc226ae-f910-5cbd-8827-be10dbc9ecc7"
title: "BACEN Compliance Sentinel"
title_cn: "BACEN 合规哨兵"
slug: "bacen-compliance-sentinel"
url: "https://lawve.ai/@rafael-mastronardi/skill/bacen-compliance-sentinel"
author: "Rafael Mastronardi"
author_slug: "rafael-mastronardi"
category: "compliance"
language: "pt"
license: "AGPL 3.0"
jurisdictions: "INT"
...
原始名称：`BACEN Compliance Sentinel`  
作者：Rafael Mastronardi  
分类：compliance  
来源：https://lawve.ai/@rafael-mastronardi/skill/bacen-compliance-sentinel  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

关于遵守巴西中央银行法规的综合指南：CMN 第 4,893/2021 号决议（网络安全政策）、BCB 第 85/2021 号决议 (GRSIC)、巴西开放金融（BCB 第 32/2020 号决议及更新）以及其他 BACEN 审慎规则。涵盖起草和审查网络安全政策、事件行动和响应计划 (PARI)、信息和通信服务风险管理 (GRSIC)、开放金融中的同意和数据共享、API 要求、第三方管理（外包）和 BACEN 制裁。触发点：Bacen、中央银行、CMN 4,893、决议 4,893、银行网络安全、PARI、GRSIC、开放金融、开放银行、金融数据共享、开放金融同意、金融 API、银行外包、网络风险、银行网络事件、金融 LGPD、金融科技合规、金融机构、DICT、Pix 安全。
