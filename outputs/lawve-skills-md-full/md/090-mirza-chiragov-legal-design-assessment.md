---
id: "530ddd1b-7c82-57f0-911c-369a4cd9eb2c"
title: "Legal Design Assessment"
title_cn: "法律设计评估"
slug: "legal-design-assessment"
url: "https://lawve.ai/@mirza-chiragov/skill/legal-design-assessment"
...
原始名称：`Legal Design Assessment`  
作者：Mirza Chiragov  
分类：legal-drafting  
来源：https://lawve.ai/@mirza-chiragov/skill/legal-design-assessment  
来源类型：外部开源 Lawve skill

## README.md 中文翻译

根据法律设计原则审核法律文件。根据六个支柱对文件进行评分：语言模式（官僚语、古语、被动语态、名词化）、可读性（Flesch Reading Ease 和特定于语言的等效项）、结构和导航、隐藏条件（隐藏在标题之外的实质性义务）、法定重复（重述法律而不是引用法律）以及可用布局的视觉层次结构。仅评估；不重写文档。适用于英语、法语和德语文件，从文件的语言和文本信号推断适用的管辖权：管辖法律条款、法规引用、当事人地址。当用户共享法律文档（合同、保密协议、条款和条件、隐私政策、内部政策）时使用，询问起草的法律设计角度如何，是否可读，是否包含隐藏条款或重述法律，或者在 Flesch / LIX / Amstad / Kandel-Moles 可读性指标上的得分如何。
